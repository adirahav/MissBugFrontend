...
import { GET_LOGGEDIN_USER, GET_USERS, UPDATE_USER, DELETE_USER, SIGNUP, LOGIN, LOGOUT } from "../reducers/user.reducer.js"
import { store } from "../store.js"

export async function setLoggedinUser(loggedinUser) {
    try {
        store.dispatch({type: GET_LOGGEDIN_USER, loggedinUser})
    } catch(err) {
